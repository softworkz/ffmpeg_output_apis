...
flowchart LR
  ...
  subgraph Graph_2_0["<div class="ff-filters"><span class="name">Graph 2.0</span><span class="description">[0:0]yadif@jf_x,split[split_1][split_2];[split_2]scale=size=512x256[scaled_1];[split_1][scaled_1]overlay[f1_out0]</span><span class="id">Graph_2_0</span></div>"]

    G2_yadif_jf_x("<div class="ff-filter"><span class="filter_name">yadif</span></div>"):::ff-filter

    G2_Parsed_split_1("<div class="ff-filter"><span class="filter_name">split</span></div>"):::ff-filter

    G2_Parsed_scale_2("<div class="ff-filter"><span class="filter_name">scale</span></div>"):::ff-filter

    G2_Parsed_overlay_3("<div class="ff-filter"><span class="filter_name">overlay</span></div>"):::ff-filter

    G2_format("<div class="ff-filter"><span class="filter_name">format</span></div>"):::ff-filter
  end
  class Graph_2_0 ff-filters

  in_0_0 == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G2_yadif_jf_x
  G2_yadif_jf_x == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G2_Parsed_split_1
  G2_Parsed_split_1 == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G2_Parsed_overlay_3
  G2_Parsed_split_1 == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G2_Parsed_scale_2
  G2_Parsed_scale_2 == "<span>yuva420p</span><br><span>512x256</span><br><span>6:5</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G2_Parsed_overlay_3
  G2_Parsed_overlay_3 == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G2_format
  G2_format == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> out__0_0

  subgraph Graph_0_1["<div class="ff-filters"><span class="name">Graph 0.1</span><span class="description">[0:2]asplit[f3_out],a3dscope,[0:0]overlay[f2_out]</span><span class="id">Graph_0_1</span></div>"]

    G0_Parsed_asplit_0("<div class="ff-filter"><span class="filter_name">asplit</span></div>"):::ff-filter

    G0_Parsed_a3dscope_1("<div class="ff-filter"><span class="filter_name">a3dscope</span></div>"):::ff-filter

    G0_Parsed_overlay_2("<div class="ff-filter"><span class="filter_name">overlay</span></div>"):::ff-filter

    G0_format_out__1_1("<div class="ff-filter"><span class="filter_name">aformat</span></div>"):::ff-filter

    G0_format("<div class="ff-filter"><span class="filter_name">format</span></div>"):::ff-filter

    G0_auto_scale_0("<div class="ff-filter"><span class="filter_name">scale</span></div>"):::ff-filter

    G0_auto_aresample_1("<div class="ff-filter"><span class="filter_name">aresample</span></div>"):::ff-filter
  end
  class Graph_0_1 ff-filters

  in_0_2 == "<span>5.1(side)</span><br><span>6 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_Parsed_asplit_0
  G0_Parsed_asplit_0 == "<span>5.1(side)</span><br><span>6 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_auto_aresample_1
  G0_Parsed_asplit_0 == "<span>5.1(side)</span><br><span>6 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_Parsed_a3dscope_1
  G0_Parsed_a3dscope_1 == "<span>rgba</span><br><span>1280x720</span><br><span>1:1</span><br><span>gbr</span><br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_auto_scale_0
  in_0_0 == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_Parsed_overlay_2
  G0_auto_scale_0 == "<span>yuva420p</span><br><span>1280x720</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_Parsed_overlay_2
  G0_Parsed_overlay_2 == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_format
  G0_auto_aresample_1 == "<span>stereo</span><br><span>2 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G0_format_out__1_1
  G0_format_out__1_1 == "<span>stereo</span><br><span>2 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> out__1_1
  G0_format == "<span>yuv420p</span><br><span>1920x800</span><br><span>1:1</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> out__1_0
  ...
  in_0_2 == "<span>5.1(side)</span><br><span>6 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G3_Parsed_aecho_0
  G3_Parsed_aecho_0 == "<span>5.1(side)</span><br><span>6 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G3_Parsed_volume_1
  G3_Parsed_volume_1 == "<span>5.1(side)</span><br><span>6 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G3_format_out__0_1
  G3_format_out__0_1 == "<span>5.1(side)</span><br><span>6 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> out__0_1
  ...
  G1_Parsed_volume_1 == "<span>7.1</span><br><span>8 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> G1_format_out__0_2
  G1_format_out__0_2 == "<span>7.1</span><br><span>8 ch</span><br><span>48.1 kHz</span><br>&nbsp;<br>&nbsp;<br>&nbsp;" ==> out__0_2
  ...
  subgraph G4_Outputs["<div class="ff-outputfiles"></div>"]
    ...
    subgraph Output_1["<div class="ff-outputfile"><span class="index">1</span><span class="muxer_name">mpegts</span><span class="file_extension">ts</span><span class="url">out2.ts</span></div>"]
  ...
  in_0_3 == "<span>Transcode</span><br>&nbsp;" ==> out__0_3
  in_0_6 == "<span>Transcode</span><br>&nbsp;" ==> out__1_2
